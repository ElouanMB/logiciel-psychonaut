...
- ⚠️ Respectez les CGU des sites (Psychonaut, Psychoactif, DrugLab)
- ⚠️ Limitez la fréquence des requêtes pour éviter les blocages anti-bot

### Notes importantes

- **2FA/CAPTCHA** : Non supporté par les scripts actuels. Utiliser Playwright si nécessaire.
- **Session expirée** : Le script relance automatiquement un login si `config/.env` est présent.
- **Structure du site** : En cas de changement, adapter les sélecteurs CSS/XPath.
...
- [Psychonaut](https://www.psychonaut.fr/) - Forum francophone de réduction des risques
- [Psychoactif](https://www.psychoactif.org/) - Communauté d'analyse de substances
- [DrugLab](https://druglab.fr/) - Laboratoire d'analyse de drogues

---

**⚠️ Avertissement** : Cet outil est destiné à des fins éducatives et de réduction des risques. L'utilisation doit être conforme aux lois en vigueur et aux conditions d'utilisation des sites concernés.
